...
@Component({
  selector: 'app-show-nexgen-pi',
  templateUrl: './show-nexgen-pi.component.html',
  styleUrls: ['./show-nexgen-pi.component.css']
})
export class ShowNexgenPiComponent implements OnInit {
  @Input() id: string;
  public mysign: any = 'assets/sign.jpg';
  public logo: any = 'assets/nexgen.jpg';
  terms: any[];
  data: any;
  workorders: any[];
  totalQt: number;
