...
@Component({
  selector: 'app-heattransfer-sample',
  templateUrl: './heattransfer-sample.component.html',
  styleUrls: ['./heattransfer-sample.component.css']
})
export class HeattransferSampleComponent implements OnInit {
  ...
  constructor(public api: ApiService,
    ...
    this.sample = new HeatTransferSample();
  ...
  viewDetail(id) {
    console.log(id);
    this.modalService
      .open(new ShowDetail('Heat Transfer Sample Details', 'heatshowtsample', id))
      .onApprove(() => {
