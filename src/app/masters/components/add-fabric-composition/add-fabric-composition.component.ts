...
import {LOV, LOVTYPE} from "../lovs/add-lov/add-lov.component";

@Component({
  selector: 'app-add-fabric-composition',
  templateUrl: './add-fabric-composition.component.html',
  styleUrls: ['./add-fabric-composition.component.css']
})
export class AddFabricCompositionComponent implements OnInit {
