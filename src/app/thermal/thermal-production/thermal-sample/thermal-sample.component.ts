...
@Component({
  selector: 'app-thermal-sample',
  templateUrl: './thermal-sample.component.html',
  styleUrls: ['./thermal-sample.component.css']
})
export class ThermalSampleComponent implements OnInit {
  ...
  viewDetail(id) {
    console.log(id);
    this.modalService
      .open(new ShowDetail('Thermal Sample Details', 'showthermal', id))
      .onApprove(() => {
      })
      .onDeny(() => {
        console.log();
