...
@Component({
  selector: 'app-screen-print-sample',
  templateUrl: './screen-print-sample.component.html',
  styleUrls: ['./screen-print-sample.component.css']
})
export class ScreenPrintSampleComponent implements OnInit {
