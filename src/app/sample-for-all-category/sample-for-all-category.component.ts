...
@Component({
  selector: 'app-sample-for-all-category',
  templateUrl: './sample-for-all-category.component.html',
  styleUrls: ['./sample-for-all-category.component.css']
})
export class SampleForAllCategoryComponent implements OnInit {
