...
import { OffsetSample } from 'src/app/offset/models/offsetSample';
import { DatePipe, Location } from '@angular/common';
declare var $: any;
@Component({
  selector: 'app-pfl-technical-details',
  templateUrl: './pfl-technical-details.component.html',
  styleUrls: ['./pfl-technical-details.component.css']
})
export class PflTechnicalDetailsComponent implements OnInit {
