...
@Component({
  selector: 'app-show-pfl-sample',
  templateUrl: './show-pfl-sample.component.html',
  styleUrls: ['./show-pfl-sample.component.css']
})
export class ShowPflSampleComponent implements OnInit {
  sample: any;
  wovenDetail: any;
  entryfield: any;
  colors: any;
